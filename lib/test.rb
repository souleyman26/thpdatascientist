...
journalists_twitter_handles = array
sorted = journalists_twitter_handles.sort
print sorted
puts " "
end
...
def handle_size
journalists_twitter_handles = array
print journalists_twitter_handles.sort{|x,y| x <=> y}
puts " "
end
